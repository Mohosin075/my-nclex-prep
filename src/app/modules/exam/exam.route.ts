...
router.put('/:examId/questions/:questionId', ExamControllers.updateQuestionInExam);
router.delete('/:examId/questions/:questionId', ExamControllers.deleteQuestionFromExam);
